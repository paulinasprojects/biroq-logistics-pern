...
export default function CompanyImageForm({ onSuccess, companyId }: Props) {
  const { uploadCompanyImage, error, isLoading } = useCompanyStore();
  ...
  async function handleUpload(e: React.FormEvent<HTMLFormElement>) {
    ...
    await uploadCompanyImage(image, companyId);
